...
const ERROR_CODE_TO_I18N_KEY: Record<FacilityRecurringErrorCode, string> = {
  ...
  [FACILITY_RECURRING_ERROR_CODES.INVALID_EXCLUSION]: "startBooking.errors.recurringInvalidExclusion",
  [FACILITY_RECURRING_ERROR_CODES.MINISTRY_CONFLICT]: "startBooking.errors.recurringMinistryConflict",
  [FACILITY_RECURRING_ERROR_CODES.SERIES_NOT_FOUND]: "booking:myBookings.errors.seriesNotFound",
  [FACILITY_RECURRING_ERROR_CODES.INVALID_CANCELLATION_SCOPE]: "booking:myBookings.errors.invalidScope",
  [FACILITY_RECURRING_ERROR_CODES.OCCURRENCE_REQUIRED]: "booking:myBookings.errors.occurrenceRequired",
  [FACILITY_RECURRING_ERROR_CODES.OCCURRENCE_NOT_FOUND]: "booking:myBookings.errors.occurrenceNotFound",
  [FACILITY_RECURRING_ERROR_CODES.HISTORICAL_OCCURRENCE]: "booking:myBookings.errors.historicalOccurrence",
};
